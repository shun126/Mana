...
#define SPRINTF std::sprintf
		...
		case IntermediateLanguage::CheckArrayIndex:	SPRINTF(text, "0x%08x:check index (array of %d element(s))", address, CodeBuffer::Raw<address_t>(program, address + 1)); break;
