...
namespace mana
{
	...
	public:
		...
		*/
		void ResolveVariableDescription(const std::shared_ptr<SyntaxNode>& node, const SymbolEntry::MemoryTypeId memoryTypeId, const bool isStaticVariable);
	...
	inline std::shared_ptr<SymbolEntry> SemanticAnalyzer::Lookup(const char* name) const
	{
