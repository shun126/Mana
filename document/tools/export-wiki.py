#!/usr/bin/env python3
"""Generate the GitHub Wiki pages from the manuscripts in `document/wiki/`.

    python document/tools/export-wiki.py --output build/wiki
    python document/tools/export-wiki.py --language ja --output build/wiki
    python document/tools/export-wiki.py --language all --output build/wiki
