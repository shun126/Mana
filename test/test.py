...
success('test_struct_method_01.mn')
success('test_struct_method_request.mn')
...
fail('test_struct_method_non_struct.mn', 'member call on non-struct type')
fail('test_struct_method_unknown.mn', "unresolved method 'Unknown' for type 'S'")
################################################################################
exit(Result)
